...
static Hrac HrajPartii()
{
	...
	HerniStrategie herniStrategiePreferujDomecekPakVyhazovani = new HerniStrategiePreferujDomecekPakVyhazovani(hra);

	Hrac hrac1 = new Hrac("Karel:PrvniFigurkou", herniStrategiePreferujDomecekPakVyhazovani);
